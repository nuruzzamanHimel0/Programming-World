...
<section class="mainRight clear">
	<table class="tbllone" >
		...
		<tr>
			...
			<td>
				<a href="teacherIndex.php?action=edt&id=<?php echo base64_encode($value["id"]); ?>">Edit</a> ||
				<a href="teacherIndex.php?action=dlt&id=<?php echo base64_encode($value["id"]); ?>" onclick='return confirm("Are u sure ?")'>Delete</a>
			</td>
		</tr>
		<?php } ?>
