	...
	<div class="headerSection template clear">
     ...
     <div class="nevigationSection template clear">
            <ul>
                ...
                <li><a href="#"> DMCA</a></li>
                <li><a id="active" href="contuct.php"> Content</a></li>
            </ul>
        </div>
         	...
         	<div class="about">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="firstName" placeholder="Enter last name"> </td>
                    </tr>
                    <tr>
                    	<td>Your Email Address</td>
                        <td><input type="email" name="email" placeholder="Enter emil address"> </td>
