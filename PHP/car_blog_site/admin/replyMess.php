    ...
    <div class="box round first grid">
        ...
        <div class="block">
            ...
            if(isset($_POST['submit']) AND $_SERVER['REQUEST_METHOD'] == 'POST')
            {
                ...
                if($sndMail)
                {
                    $succmsg = "<p style=\"font-size:20px;color:green;text-align: center;\"> Message Send Successfully.</p>";

                }
                else{
                    $errmsg = "<p style=\"font-size:20px;color:red;text-align: center;\">Sorry, Fail to Message Send !!</p>";
