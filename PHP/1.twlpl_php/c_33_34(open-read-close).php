...
<h2 style="text-align: center;"> File Handling Class:33,34(OPEN-READ-CLOSE)</h2>
...
<?php 
	...
	// $fileopen = fopen("file/text.txt","r") or die("File not found");
	// echo fread($fileopen, filesize("file/text.txt"));
	// fclose($fileopen);
