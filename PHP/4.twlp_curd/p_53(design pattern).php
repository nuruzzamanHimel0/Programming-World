...
<section class="mainRight clear">
    <table class="tbllone" >
            ...
            <tr>
                    ...
                    <td>
                            <a href="p_53(design pattern).php?action=edt&id=<?php echo $value['id'];?>">Edit</a> ||
                            <a href="p_53(design pattern).php?action=dlt&id=<?php echo $value['id'];?>" onClick="return confirm('Are You Sure ?');">Delete</a>
                    </td>
            </tr>
            <?php 
            }
