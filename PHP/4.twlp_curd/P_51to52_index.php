...
<div class="titleSection clear">
	...
	<h2><a href="P_51to52_index.php">Create New</a>  </h2>
</div>
<?php 
...
<section class="mainRight clear">
    <table class="tbllone" >
            ...
            <tr>
                    ...
                    <td>
                            <a href="P_51to52_index.php?action=edt&id=<?php echo $value['id'];?>">Edit</a> ||
                            <a href="P_51to52_index.php?action=dlt&id=<?php echo $value['id'];?>" onClick="return confirm('Are You Sure ?');">Delete</a>
                    </td>
            </tr>
            <?php 
            }
